    ...
    <WindowWrapper>
      <Window className="window">
        <WindowHeader style={{ padding: "0 0.8rem" }} className="window-header">
          <span>Nasoori_info.exe </span>
        </WindowHeader>

        <WindowContent style={{ padding: 0 }}>
          <Tabs
            value={activeTab}
            style={{ margin: "0.3rem 0.5rem 0" }}
            onChange={handleChange}
          >
            <Tab style={tabStyle} value={0}>
              About
            </Tab>
            <Tab style={tabStyle} value={1}>
              Skills
            </Tab>
            <Tab style={tabStyle} value={2}>
              Projects
            </Tab>
            <Tab style={tabStyle} value={3}>
              Resume
            </Tab>
            <Tab style={tabStyle} value={4}>
              Contact
            </Tab>
          </Tabs>
      ...
      {showDog && <MyDog hideDog={handleHideDog} />}
    </WindowWrapper>
  );
};
