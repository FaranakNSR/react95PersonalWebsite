    ...
    <div>
      ...
      <div>
        <Fieldset className={styles.margin} label="Email address">
          <Anchor href="mailto:faranaknasoori@gmail.com@gmail.com">
            faranaknasoori@gmail.com
          </Anchor>
        </Fieldset>
        <Fieldset className={styles.margin} label="Primary Phone">
          <Anchor href="tel:780-802-6276">+1 (780) 802 - 6276</Anchor>
        </Fieldset>
      </div>
        ...
        {contactSent && (
          <div style={{ marginTop: "2rem" }}>
            <div className={styles.feedBack}>
              ...
              <Button onClick={handleResetMessage} size="sm">
                {resetButton}
              </Button>
            </div>

            {loadingBar && <LoadingIndicator isLoading={loadingBar} />}
          </div>
        )}
        {!contactSent && (
